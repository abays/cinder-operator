...
require (
	...
	github.com/openstack-k8s-operators/keystone-operator v0.0.0-20220708133335-266d701ad809
...
require (
	...
	github.com/openstack-k8s-operators/mariadb-operator v0.0.0-20220516121356-119f8d825a71 // indirect
